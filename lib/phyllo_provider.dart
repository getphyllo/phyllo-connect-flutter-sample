...
import 'package:flutter_sample_app/client/phyllo_repository.dart';
...
class PhylloProvider extends DefaultChangeNotifier {
  ...
  void launchSdk(String workPlatformId) async {
    try {
      ...
      String? env =
          await getPhylloEnvironmentUrl(Configs.environment);
  ...
  void _launchSdk(String workPlatformId) async {
